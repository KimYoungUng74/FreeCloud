...
public class ProjectDTO {
	...
	private String PROJECT_MAIN_KETEGORY;
	private String PROJECT_MIDDLE_KATEGORY;
	private String WORKING_KIND;
	...
	public String getPROJECT_MAIN_KETEGORY() {
		return PROJECT_MAIN_KETEGORY;
	}
	public void setPROJECT_MAIN_KETEGORY(String pROJECT_MAIN_KETEGORY) {
		PROJECT_MAIN_KETEGORY = pROJECT_MAIN_KETEGORY;
	}
	...
	public String getWORKING_KIND() {
		return WORKING_KIND;
	}
	public void setWORKING_KIND(String wORKING_KIND) {
	...
	public String toString() {
		return "ProjectDTO [PROJECT_IDX=" + PROJECT_IDX + ", USER_ID=" + USER_ID + ", PROJECT_MAIN_KETEGORY="
				+ PROJECT_MAIN_KETEGORY + ", PROJECT_MIDDLE_KATEGORY=" + PROJECT_MIDDLE_KATEGORY + ", WORKING_KIND="
				+ WORKING_KIND + ", PROJECT_SUBJECT=" + PROJECT_SUBJECT + ", PROJECT_START_DATE=" + PROJECT_START_DATE
				+ ", PROJECT_END_DATE=" + PROJECT_END_DATE + ", PROJECT_ADDRESS=" + PROJECT_ADDRESS
				+ ", PROJECT_BUDGET=" + PROJECT_BUDGET + ", PROOJECT_BUDGET_COORDINATION="
				+ PROJECT_BUDGET_COORDINATION + ", PROJECT_IMAGE_PATH=" + PROJECT_IMAGE_PATH + ", PROJECT_STATUS="
				+ PROJECT_STATUS + ", PROJECT_VIEWS=" + PROJECT_VIEWS + ", getClass()=" + getClass() + ", hashCode()="
