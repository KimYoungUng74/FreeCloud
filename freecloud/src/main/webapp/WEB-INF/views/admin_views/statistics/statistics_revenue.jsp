					...
					<div class="col-md-9 col-sm-9 col-xs-12"">
						<div
							...
							<div class="row">
								<div class="col-md-12">
									<p>
										<label style="font-size: 15px; color: gray;"> 수익 통계
										</label>
									<p>
									...
									<div
										...
										<br>
										<span style="display:inline-block; width:30%; font-size:25px; background-color:#CCCC">중개수수료</span>
										<span style="display:inline-block; width:30%; font-size:25px; background-color:#CCCC">프리미엄 구독료</span>
