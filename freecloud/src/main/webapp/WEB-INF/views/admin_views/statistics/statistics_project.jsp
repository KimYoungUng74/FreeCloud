					...
					<div class="col-md-9 col-sm-9 col-xs-12"">
						<div
							...
							<div class="row">
								<div class="col-md-12">
									<p>
										<label style="font-size: 15px; color: gray;"> 프로젝트 통계
										</label>
									<p>
									...
									<div
										...
										<br>
										<span style="display:inline-block; width:30%; font-size:25px; background-color:#CCCC">등록된 게시글</span>
										<span style="display:inline-block; width:30%; font-size:25px; background-color:#CCCC">진행중 프로젝트</span>
