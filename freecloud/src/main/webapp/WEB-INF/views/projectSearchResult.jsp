...
function search(){
	var wk1 = $("input:radio[name='PROJECT_WORKING_KIND']:checked").val();
	var sel = document.getElementById('cntPerPage').value;
	...
	$("input[name='PROJECT_WORKING_KIND']:checked").each(function() {
		wk.push( $(this).val());	    	
    })
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-md-8 col-sm-6">
												...
												<li class="listc"><label for="chk3"> <input
														type="checkbox" name="PROJECT_MIDDLE_KATEGORY_DS" id="PROJECT_MIDDLE_KATEGORY_DS" value="프리젠테이션">&nbsp;프레젠테이션
												</label></li>
							...
							<div class="shop-widget-bottom">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<br><br>
										<button name="pReg" id="pReg" type="button" onclick="search();"
