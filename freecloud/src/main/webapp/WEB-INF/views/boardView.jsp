	...
	<div class="login-account section-padding">
		<div class="container">
			<div class="row">
				<div>
				<c:choose>
							<c:when test="${sessionScope.userId eq dto.USER_ID}">
								
								<form action="boardUpdateOk.do?" class="create-account-form" method="post" id="frm">
								<h2 class="heading-title">${dto.USER_ID} 게시글 상세 </h2>
									...
									<div class="shop-select" style="display: inline; width: 25%;">
										...
										<select name="BBS_MAIN_KATEGORY" id="BBS_MAIN_KATEGORY" style="width: 25%">
											...
											<option value="잡담" <c:if test="${dto.BBS_MAIN_KATEGORY == '잡담'}">selected="selected"</c:if>>잡담</option>
											<option value="질문" <c:if test="${dto.BBS_MAIN_KATEGORY == '질문'}">selected="selected"</c:if>>질문</option>
											<option value="정보공유"<c:if test="${dto.BBS_MAIN_KATEGORY == '정보공유'}">selected="selected" </c:if>>정보공유</option>
											
										</select>
									</div>		
									
									<input type="hidden" value="${dto.BBS_IDX }" name="BBS_IDX" id="BBS_IDX">
									<p class="form-row">
										<b>제목</b><b></b><label for="subMessage" id="subMessage"></label></b> <br>
										<br> <input type="text" name="BBS_SUBJECT" id="BBS_SUBJECT" placeholder="제목" onkeyup="subCheck()" value="${dto.BBS_SUBJECT }"">
									</p>
									...
									<p class="form-row order-notes">
										<textarea name="BBS_CONTENT" id="BBS_CONTENT" placeholder="상세 내용 기입" onkeyup="conCheck()">${dto.BBS_CONTENT }</textarea>
									</p>
									...
									<button name="pCancle" id="pCancle" type="button"
										class="btn-default" style="width:51%" onclick='history.go(-1)'>
								...
								<h2 class="heading-title">${dto.USER_ID} 게시글 상세</h2>
									...
									<div class="shop-select" style="display: inline; width: 25%;">
										...
										<select name="BBS_MAIN_KATEGORY" id="BBS_MAIN_KATEGORY" style="width: 25%">
											...
											<option value="${dto.BBS_MAIN_KATEGORY }">${dto.BBS_MAIN_KATEGORY }</option>
										</select>
									</div>		
									
									<p class="form-row">
										<b>제목</b><b></b><label for="subMessage" id="subMessage"></label></b> <br>
										<br> <input type="text" name="BBS_SUBJECT" id="BBS_SUBJECT" placeholder="제목" onkeyup="subCheck()" value="${dto.BBS_SUBJECT }" readonly="readonly">
									</p>
									...
									<p class="form-row order-notes">
										<textarea name="BBS_CONTENT" id="BBS_CONTENT" placeholder="상세 내용 기입" onkeyup="conCheck()" readonly="readonly">${dto.BBS_CONTENT }</textarea>
									</p>
